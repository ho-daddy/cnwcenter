              ...
              {hazards.map(h => {
                ...
                return (
                  <tr key={h.id} className="border-b hover:bg-gray-50 group">
                    ...
                    <td className="py-2 px-3 text-center">
                      {completedCnt > 0 && (
                        <span className="inline-block text-xs bg-green-100 text-green-700 px-1.5 py-0.5 rounded mb-0.5">완료 {completedCnt}</span>
                      )}
                      {plannedCnt > 0 && (
                        <span className="inline-block text-xs bg-yellow-100 text-yellow-700 px-1.5 py-0.5 rounded">예정 {plannedCnt}</span>
                      )}
                      {h.improvements.length === 0 && <span className="text-xs text-gray-300">-</span>}
                    </td>
                    <td className="py-2 px-3">
